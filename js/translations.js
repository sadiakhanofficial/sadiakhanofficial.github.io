...
const TRANSLATIONS = {
  de: {
    ...
    about_p1: "Ich bin eine detailorientierte Full-Stack-Entwicklerin mit fundierter Praxiserfahrung in moderner Frontend- und Backend-Entwicklung. Mein Schwerpunkt liegt auf der Entwicklung und Wartung skalierbarer Webanwendungen mit agilem Vorgehen und durchdachter Softwarearchitektur.",
    about_p2: "Ob moderne reaktive Interfaces mit React, Vue oder Angular, hochperformante Microservices mit Node.js, Express, Django oder Laravel, oder relationale und NoSQL-Datenbanken: Ich verbinde technische Exzellenz mit nutzerzentriertem Design und geschäftlichem Mehrwert.",
    ...
    about_degree_val: "Graduiert (Informatik · FAST NUCES)",
    ...
    // Skills
    skills_eyebrow: "Technologie-Stack",
    skills_heading: "Kernkompetenzen & Moderne Werkzeuge",
    skills_sub: "Ein erprobter Technologie-Stack für moderne, zukunftssichere und performante Webanwendungen.",
    skills_cat_frontend: "Frontend-Entwicklung",
    skills_cat_frontend_desc: "Moderne, responsive Benutzeroberflächen mit höchster Barrierefreiheit und flüssigen Animationen.",
    skills_cat_backend: "Backend & Cloud",
    skills_cat_backend_desc: "Robuste Server-Architekturen, RESTful APIs, GraphQL und Cloud-Infrastrukturen.",
    skills_cat_database: "Datenbanken & DevOps",
    skills_cat_database_desc: "Effiziente Datenmodellierung, relationale & NoSQL-Systeme, Containerisierung und CI/CD.",
    skills_cat_methods: "Marketing & Optimierung",
    skills_cat_methods_desc: "Technisches SEO, Performance-Tuning (Core Web Vitals), Google Analytics und Conversion-Optimierung.",

    // Projects
    projects_eyebrow: "Portfolio & Fallstudien",
    projects_heading: "Ausgewählte Produktiv-Projekte",
    projects_sub: "25 interaktive Architektur-Fallstudien und Anwendungen aus den Bereichen Enterprise, Healthcare, KI und Mobile.",
    filter_all: "Alle (25)",
    filter_enterprise: "Unternehmen & SaaS",
    filter_ai_health: "KI & MedTech",
    filter_mobile_media: "Medien & Mobile",
    filter_tools_os: "Tools & Open Source",
  ...
  en: {
    ...
    about_p1: "I am a detail-oriented Full Stack Developer with extensive hands-on expertise across both frontend and backend domains. My core focus is designing, deploying, and maintaining scalable web applications with strong emphasis on performance, accessibility, and robust code architecture.",
    about_p2: "Whether engineering reactive user interfaces in React, Vue, or Angular, orchestrating resilient backends with Node.js, Express, Django, or Laravel, or managing relational and NoSQL databases: I bridge engineering rigor with intuitive user experiences and measurable business value.",
    ...
    about_degree_val: "Graduated (Computer Science · FAST NUCES)",
    ...
    skills_heading: "Core Competencies & Modern Toolchain",
    skills_sub: "A production-proven technology stack designed for high throughput, maintainability, and exceptional user experience.",
    skills_cat_frontend: "Frontend Engineering",
    skills_cat_frontend_desc: "Dynamic, accessible, and responsive user interfaces with smooth interactions.",
    skills_cat_backend: "Backend & Cloud",
    skills_cat_backend_desc: "Scalable server architectures, RESTful APIs, GraphQL endpoints, and cloud deployments.",
    skills_cat_database: "Databases & DevOps",
    skills_cat_database_desc: "Relational & NoSQL modeling, Docker containerization, CI/CD pipelines, and Git workflows.",
    skills_cat_methods: "Optimization & Growth",
    skills_cat_methods_desc: "Technical SEO, Core Web Vitals optimization, Google Analytics, CRO, and agile delivery.",

    // Projects
    projects_eyebrow: "Portfolio & Case Studies",
    projects_heading: "Featured Production Projects",
    projects_sub: "25 interactive architectural case studies and live systems across Enterprise, Healthcare, AI, and Mobile platforms.",
    filter_all: "All (25)",
